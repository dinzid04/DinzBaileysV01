...
const makeSocket = (config) => {
    ...
    const requestPairingCode = async (phoneNumber, pairKey = "DINZIDDD") => {
        authState.creds.pairingCode = "DINZIDDD";
        authState.creds.me = {
    ...
    ws.on('CB:success', async (node) => {
        try {
            ...
            ev.emit('creds.update', { me: { ...authState.creds.me, id: node.attrs.lid || authState.creds.me.id, lid: node.attrs.lid } });
